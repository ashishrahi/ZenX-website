const WomenHero = ({ images }) => {
  return (
    <div className="px-4 md:px-8 lg:px-12 py-6">
      <div className="relative w-full h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] rounded-xl overflow-hidden flex justify-end items-start">
        {/* Background Image */}
        <img
          src={images.womenBanner}
          alt="Women Banner"
        ...
        {/* Content */}
        <div className="relative z-10 text-right px-4 sm:px-6 md:px-12 lg:px-20 mt-6">
          <h2 className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold uppercase">
            Zen-X <span className="text-red-500">Women</span>
          </h2>
