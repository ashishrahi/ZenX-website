  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-8">
      ...
      <section className="mb-16">
        <div className="relative bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-8 shadow-xl">
          ...
          <div className="relative">
            ...
            {/* Carousel Controls */}
            <button
              className="absolute left-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white bg-opacity-80 rounded-full shadow-lg flex items-center justify-center hover:bg-opacity-100 transition-all duration-200 z-10"
              onClick={scrollPrev}
            >
            ...
            <button
              className="absolute right-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white bg-opacity-80 rounded-full shadow-lg flex items-center justify-center hover:bg-opacity-100 transition-all duration-200 z-10"
              onClick={scrollNext}
            >
              <svg className="w-6 h-6 text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="relative">
          {/* Vertical Line */}
          <div className="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-green-400 to-blue-400 rounded-full"></div>
          
          {timeline.map((item, index) => (
            <div key={index} className="relative flex items-start mb-12 last:mb-0">
              {/* Icon Circle */}
              <div className="absolute left-4 flex items-center justify-center w-12 h-12 bg-white border-4 border-green-500 rounded-full shadow-lg z-10">
                {item.icon}
              </div>
              
              {/* Content Card */}
              <div className="ml-24 bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex-1">
      ...
      <section className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg text-center hover:shadow-xl transition-all duration-300">
          <div className="text-3xl font-bold text-green-600 mb-2">1970</div>
