        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-background/80 text-sm">
              <li>
                <a href="#" className="hover:text-background transition-colors">Mens</a>
              </li>
              <li>
                <a href="#" className="hover:text-background transition-colors">Women</a>
              </li>
              <li>
                <a href="#" className="hover:text-background transition-colors">Kids</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-background/80 text-sm">
              <li>
                <a href="#" className="hover:text-background transition-colors">About Us</a>
              </li>
              <li>
                <a href="#" className="hover:text-background transition-colors">Quality Policy</a>
              </li>
              <li>
                <a href="#" className="hover:text-background transition-colors">Warranty</a>
              </li>
              <li>
                <a href="#" className="hover:text-background transition-colors">Career</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-background/80 text-sm">
              <li>
                <a href="#" className="hover:text-background transition-colors">Downloads</a>
              </li>
              <li>
                <a href="#" className="hover:text-background transition-colors">Dealer Locator</a>
              </li>
              <li>
