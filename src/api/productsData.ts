...
export const trendingProducts = [
  {
    id: 1,
    name: "Premium Cotton Innerwear",
    description: "Soft cotton innerwear for daily comfort",
    images: { Burgundy: [Sweater],
      Black: [Sweater],
      Grey: [Sweater], },
    price: 699,
    discountPrice: 499,
    slug: "premium-cotton-innerwear",
    category: "innerwear",
  ...
  },
  {
    ...
    category: "winter-wear",
    colors: ["#FF5733", "#2E86C1"],
    bestSeller: false,
  },
  {
    id: 3,
    name: "Thermal Winter Set",
    description: "Thermal set to keep you warm all winter",
    images: { Burgundy: [Sweater],
      Black: [Sweater],
      Grey: [Sweater], },
    price: 1299,
    discountPrice: 899,
    slug: "thermal-winter-set",
    category: "winter-wear",
    colors: ["#6A1B9A", "#BDBDBD"],
    bestSeller: true,
  },
  {
    id: 5,
